...
function MaterialIcon({name}:{name:string}){
  ...
  if(name==="INDUGEL")return <svg viewBox="0 0 42 28" className="h-5 w-8" aria-hidden="true"><path d="M5 10.5h32c1.3 0 2 1.5 2 3.5s-.7 3.5-2 3.5H5c-1.3 0-2-1.5-2-3.5s.7-3.5 2-3.5Z" fill="#e5e7eb" stroke="currentColor" strokeWidth="1.7"/><path d="M5 10.5v7m32-7v7M3.5 12 1.5 11m2 5L1.5 17m37-5 2-1m-2 5 2 1" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/><path d="m10 12.5 3 3m6-3 3 3m6-3 3 3" fill="none" stroke="#dc2626" strokeWidth="1.1" strokeLinecap="round"/></svg>;
