...
function MaterialIcon({name}:{name:string}){
  ...
  return <svg viewBox="0 0 52 42" className="h-8 w-9" aria-hidden="true"><g fill="#f97316"><path d="m25 10 1-9 1.3 9Z"/><path d="m31 11.2 4-8-1.4 9Z"/><path d="m36.5 14 7-6-4.8 8Z"/><path d="m40 18 10-2-8.7 4Z"/><path d="m40.5 23 10 2-9.3.2Z"/><path d="m37.8 27.3 7.5 6-9-3.7Z"/><path d="m33 30.5 4 9-6-8Z"/><path d="m26.8 32 1 9-3-8.8Z"/><path d="m20.5 31-3 9-1-9.8Z"/><path d="m15 28.5-7 7 4.8-8.7Z"/><path d="m11.5 24-10 3 8.8-5.2Z"/><path d="m11 19-10-1 9.5-1.5Z"/><path d="m14 14.8-7-6.5 9 4Z"/><path d="m19.2 11.5-3.5-9 5.5 8.2Z"/></g><g fill="#facc15"><path d="m28.5 10.5 2.2-6-.3 6.8Z"/><path d="m34 12.7 5-5-3.3 6.5Z"/><path d="m39 16 7-3.5-5.7 5.4Z"/><path d="m41 21 7.5.2-7.3 2Z"/><path d="m39.5 25.7 6 4.5-7.2-2.8Z"/><path d="m35.3 29.3 3 6.5-5-5.3Z"/><path d="m29.8 31.5.2 6.8-2.4-6.4Z"/><path d="m23 31.7-1.5 6.5-.6-6.8Z"/><path d="m17.3 30-4.5 5 2.8-6.5Z"/><path d="m12.5 26.5-7 2.2 5.8-4.2Z"/><path d="m10.3 21.5-7-.8 7-1.5Z"/><path d="m11.8 16.5-6-3.5 7 1.8Z"/><path d="m16.5 12.7-4-5.5 5.8 4Z"/><path d="m22 10.5-.5-6.5 2.6 6.3Z"/></g><ellipse cx="26" cy="21" rx="13" ry="7.5" fill="#fff"/><g transform="rotate(-24 26 21)"><path d="M10 17.5h32c1.7 0 2.5 1.6 2.5 3.5s-.8 3.5-2.5 3.5H10c-1.6 0-2.5-1.6-2.5-3.5s.9-3.5 2.5-3.5Z" fill="#d1d5db" stroke="currentColor" strokeWidth="1"/><path d="M10.5 19h27" fill="none" stroke="#fff" strokeWidth="1" strokeLinecap="round" opacity=".9"/><path d="M11 23h26" fill="none" stroke="#9ca3af" strokeWidth=".7" strokeLinecap="round"/><path d="M36.5 17.7c-1 2.2-1 4.4 0 6.6m2.3-6.6c-1 2.2-1 4.4 0 6.6m2.3-6.5c-.9 2.1-.9 4.3 0 6.4" fill="none" stroke="#6b7280" strokeWidth="1.15"/></g></svg>;
}
