...
function MaterialIcon({name}:{name:string}){
  ...
  return <svg viewBox="0 0 50 38" className="h-8 w-9" aria-hidden="true"><g transform="rotate(-24 25 19)"><path d="m8.5 3.5 1.8 7 5.2-4.6-2.4 6.7 7-1.2-5.8 4.2 6.6 2.8-7.1.4 4.7 5.4-6.6-2.7 1.3 7-4.2-5.9-2.5 6.7-.3-7.1-5.4 4.7 2.8-6.5-7.1 1.8 5.9-4-6.7-.7 7.1-2.7-4.8-5.2 6.6 2.2L3.5 5.8l4.2 5.7.8-8Z" fill="#f97316" stroke="#c2410c" strokeWidth=".6" strokeLinejoin="round"/><path d="m1.5 7.5-1.2-3 3.1 1-1.9 2Zm.4 23-2.5 1.6.5-3.2 2 1.6Zm12.5-27L15.6.4l1 3.2-2.2-.1Z" fill="#fb923c"/><path d="M15 15.5h29c1.7 0 2.5 1.6 2.5 3.5s-.8 3.5-2.5 3.5H15c-1.6 0-2.5-1.6-2.5-3.5s.9-3.5 2.5-3.5Z" fill="#d1d5db" stroke="currentColor" strokeWidth="1"/><path d="M15.5 17h24.5" fill="none" stroke="#fff" strokeWidth="1" strokeLinecap="round" opacity=".9"/><path d="M16 21h24" fill="none" stroke="#9ca3af" strokeWidth=".7" strokeLinecap="round"/><path d="M39 15.7c-1 2.2-1 4.4 0 6.6m2.3-6.6c-1 2.2-1 4.4 0 6.6m2.3-6.5c-.9 2.1-.9 4.3 0 6.4" fill="none" stroke="#6b7280" strokeWidth="1.15"/></g></svg>;
}
