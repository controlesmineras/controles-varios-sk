...
function MaterialIcon({name}:{name:string}){
  ...
  return <svg viewBox="0 0 46 34" className="h-7 w-8" aria-hidden="true"><g transform="rotate(-24 23 17)"><path d="m7 7.5 1.2 5 4-2.9-2.1 4.8 5 .2-4.5 2.4 4 3-5-.8 1 5-3.4-3.8-1.5 4.8-.8-5-4 2.8 2-4.7-5-.4 4.5-2.2-3.8-3.2 4.8 1L3 7.7l3.4 3.7L7 7.5Z" fill="#f97316" stroke="#c2410c" strokeWidth=".55" strokeLinejoin="round"/><path d="m1.5 8.5-1-2.3 2.4.8-1.4 1.5Zm.2 16.8-2.1 1.2.5-2.5 1.6 1.3Z" fill="#fb923c"/><path d="M9 13.5h31.5c1.7 0 2.5 1.6 2.5 3.5s-.8 3.5-2.5 3.5H9c-1.6 0-2.5-1.6-2.5-3.5s.9-3.5 2.5-3.5Z" fill="#d1d5db" stroke="currentColor" strokeWidth="1"/><path d="M9.5 15h27" fill="none" stroke="#fff" strokeWidth="1" strokeLinecap="round" opacity=".9"/><path d="M10 19h26" fill="none" stroke="#9ca3af" strokeWidth=".7" strokeLinecap="round"/><path d="M35.5 13.7c-1 2.2-1 4.4 0 6.6m2.3-6.6c-1 2.2-1 4.4 0 6.6m2.3-6.5c-.9 2.1-.9 4.3 0 6.4" fill="none" stroke="#6b7280" strokeWidth="1.15"/></g></svg>;
}
