...
function MaterialIcon({name}:{name:string}){
  ...
  return <svg viewBox="0 0 42 30" className="h-7 w-8" aria-hidden="true"><g transform="rotate(-24 21 15)"><path d="M5 11.5h31.5c1.7 0 2.5 1.6 2.5 3.5s-.8 3.5-2.5 3.5H5c-1.6 0-2.5-1.6-2.5-3.5s.9-3.5 2.5-3.5Z" fill="#d1d5db" stroke="currentColor" strokeWidth="1"/><path d="M5.5 13h27" fill="none" stroke="#fff" strokeWidth="1" strokeLinecap="round" opacity=".9"/><path d="M6 17h26" fill="none" stroke="#9ca3af" strokeWidth=".7" strokeLinecap="round"/><path d="M31.5 11.7c-1 2.2-1 4.4 0 6.6m2.3-6.6c-1 2.2-1 4.4 0 6.6m2.3-6.5c-.9 2.1-.9 4.3 0 6.4" fill="none" stroke="#6b7280" strokeWidth="1.15"/></g></svg>;
}
